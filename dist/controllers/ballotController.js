...
exports.exportBallotForDeployment = exports.getBallotVersion = exports.getBallotVersionHistory = exports.createNewBallotVersion = exports.unpublishBallot = exports.publishBallot = exports.getPublicBallot = exports.getElectionBallot = exports.createOrUpdateBallot = void 0;
...
const createOrUpdateBallot = async (req, res) => {
    try {
        if (!req.user) {
        ...
        let ballot = await Ballot_1.default.findOne({ electionId, isActive: true });
        if (ballot) {
...
exports.createOrUpdateBallot = createOrUpdateBallot;
...
exports.getElectionBallot = getElectionBallot;
// Get public ballot for voting (no authentication required)
const getPublicBallot = async (req, res) => {
    try {
        const { electionId } = req.params;
...
exports.getPublicBallot = getPublicBallot;
// Publish ballot
const publishBallot = async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ message: 'Authentication required' });
        }
...
exports.publishBallot = publishBallot;
// Unpublish ballot
const unpublishBallot = async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ message: 'Authentication required' });
        }
...
exports.unpublishBallot = unpublishBallot;
// Create new ballot version
const createNewBallotVersion = async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ message: 'Authentication required' });
        }
        ...
        const currentBallot = await Ballot_1.default.findOne({ electionId, isActive: true });
        if (currentBallot) {
            // Unpublish current ballot
            await currentBallot.unpublish();
        }
        // Create new ballot version
        const newBallot = new Ballot_1.default({
            electionId,
            title,
            description,
            questions,
...
exports.createNewBallotVersion = createNewBallotVersion;
// Get ballot version history
const getBallotVersionHistory = async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ message: 'Authentication required' });
        }
        ...
        const ballots = await Ballot_1.default.find({ electionId })
...
exports.getBallotVersionHistory = getBallotVersionHistory;
// Get specific ballot version
const getBallotVersion = async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ message: 'Authentication required' });
        }
        ...
        // Get specific ballot version
        const ballot = await Ballot_1.default.findOne({ electionId, version: Number(version) });
        if (!ballot) {
...
exports.getBallotVersion = getBallotVersion;
// Export ballot for blockchain deployment
const exportBallotForDeployment = async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ message: 'Authentication required' });
        }
...
exports.exportBallotForDeployment = exportBallotForDeployment;
