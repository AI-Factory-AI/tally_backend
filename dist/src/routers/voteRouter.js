...
router.post('/:electionId/prepare', validateElectionId, (0, express_validator_1.body)('voterId').isString(), (0, express_validator_1.body)('voteHash').isString(), voteController_1.prepareBlockchainVote);
// Record a broadcasted tx hash from the frontend wallet
router.post('/:electionId/record', validateElectionId, (0, express_validator_1.body)('voterId').isString(), (0, express_validator_1.body)('txHash').isString().isLength({ min: 66, max: 66 }), voteController_1.recordBlockchainVote);
// Get vote by voter
