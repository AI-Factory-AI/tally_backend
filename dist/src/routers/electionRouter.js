...
router.post('/user/:electionId/update-deployment', auth_1.validateElectionOwnership, electionController_1.updateElectionDeployment);
router.post('/user/:electionId/activate', auth_1.validateElectionOwnership, electionController_1.activateElection);
router.post('/user/:electionId/start-onchain', auth_1.validateElectionOwnership, electionController_1.startElectionOnChain);
